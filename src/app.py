...
@st.cache_resource
def load_resources():
    model = load_model("..\\data\\tokenizer_data_test\\0.94_0.97\\trained_model.keras")
    vocab = joblib.load("..\\data\\tokenizer_data_test\\0.94_0.97\\vocab.pkl")
    label_encoder_disease = joblib.load("..\\data\\tokenizer_data_test\\0.94_0.97\\label_encoder_disease.pkl")
    label_encoder_prescription = joblib.load("..\\data\\tokenizer_data_test\\0.94_0.97\\label_encoder_prescription.pkl")
